...
export interface ITicketingService {
  ...
  updateStatus(id: string, status: TicketStatus, refund?: boolean, amount?: number): Promise<Ticket | null>;
  resolveTicket(ticketId: string, refund: boolean, amount?: number): Promise<void>;
