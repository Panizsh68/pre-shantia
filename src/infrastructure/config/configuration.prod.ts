...
export function validateProductionEnvironment(env: NodeJS.ProcessEnv = process.env): ProductionCoreConfig {
  ...
  return {
    ...
    RATE_LIMITS: {
      ...
      VENDOR_IMAGE_UPLOAD_MAX: parseNumber('RATE_LIMIT_VENDOR_IMAGE_UPLOAD_MAX', env, 5), VENDOR_IMAGE_UPLOAD_WINDOW_SECONDS: parseNumber('RATE_LIMIT_VENDOR_IMAGE_UPLOAD_WINDOW_SECONDS', env, 3600),
