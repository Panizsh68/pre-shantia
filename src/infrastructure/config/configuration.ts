...
export default (): AppConfiguration => {
  ...
  return {
    ...
    RATE_LIMITS: {
      ...
      VENDOR_IMAGE_UPLOAD_MAX: parseNumber(process.env.RATE_LIMIT_VENDOR_IMAGE_UPLOAD_MAX, 5), VENDOR_IMAGE_UPLOAD_WINDOW_SECONDS: parseNumber(process.env.RATE_LIMIT_VENDOR_IMAGE_UPLOAD_WINDOW_SECONDS, 3600),
